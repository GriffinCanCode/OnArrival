#!/usr/bin/env python3
"""
Helper script to start the OnArrival backend server on port 7392 for frontend development.
...
def main():
    ...
    print("🚀 Starting OnArrival backend server on port 7392...")
    print("   This will make the backend accessible to the React frontend")
    print("   Press Ctrl+C to stop the server")
    print()
    
    try:
        # Change to project root and run the web app on port 7392
